...
define internal void @__ssa_engine_toy_structure__beam_bank_run__planned_region_0(ptr %arg.0, ptr %arg.1, ptr %arg.2, ptr %arg.3, ptr %arg.4, ptr %arg.5, ptr %arg.6, ptr %arg.7, ptr %arg.8, ptr %arg.9, ptr noalias %arg.10, ptr noalias %arg.11, ptr noalias %arg.12, ptr %arg.13, ptr %out.0, ptr %out.1, ptr %out.2, ptr %out.3, ptr %out.4, ptr %out.5, ptr %out.6, ptr %out.7, ptr %out.8, ptr %extents) {
entry:
  ...
  %load.31.207.0 = load i32, ptr %arg.1, align 4
  %address.31.207 = getelementptr double, ptr %arg.0, i32 %load.31.207.0
  %pinned.load.32.16 = load double, ptr %address.31.207, align 8
  store double %pinned.load.32.16, ptr %out.0, align 8
  %address.33.208 = getelementptr double, ptr %arg.2, i32 %load.31.207.0
  %pinned.load.34.17 = load double, ptr %address.33.208, align 8
  store double %pinned.load.34.17, ptr %out.1, align 8
  %address.35.209 = getelementptr double, ptr %arg.3, i32 %load.31.207.0
  %pinned.load.36.18 = load double, ptr %address.35.209, align 8
  store double %pinned.load.36.18, ptr %out.2, align 8
  %address.37.210 = getelementptr double, ptr %arg.4, i32 %load.31.207.0
  %pinned.load.38.19 = load double, ptr %address.37.210, align 8
  store double %pinned.load.38.19, ptr %out.3, align 8
  %address.39.211 = getelementptr double, ptr %arg.5, i32 %load.31.207.0
  %pinned.load.40.20 = load double, ptr %address.39.211, align 8
  store double %pinned.load.40.20, ptr %out.4, align 8
  %address.41.212 = getelementptr double, ptr %arg.6, i32 %load.31.207.0
  %pinned.load.42.21 = load double, ptr %address.41.212, align 8
  store double %pinned.load.42.21, ptr %out.5, align 8
  %address.43.213 = getelementptr double, ptr %arg.7, i32 %load.31.207.0
  %pinned.load.44.22 = load double, ptr %address.43.213, align 8
  store double %pinned.load.44.22, ptr %out.6, align 8
  %address.45.214 = getelementptr double, ptr %arg.8, i32 %load.31.207.0
  %pinned.load.46.23 = load double, ptr %address.45.214, align 8
  store double %pinned.load.46.23, ptr %out.7, align 8
  %address.47.215 = getelementptr double, ptr %arg.9, i32 %load.31.207.0
  %pinned.load.48.24 = load double, ptr %address.47.215, align 8
  store double %pinned.load.48.24, ptr %out.8, align 8
  %address.49.216 = getelementptr double, ptr %arg.10, i32 %load.31.207.0
  %pinned.load.50.25 = load double, ptr %address.49.216, align 8
  store double %pinned.load.50.25, ptr %value.25, align 8
  %address.51.217 = getelementptr double, ptr %arg.11, i32 %load.31.207.0
  %pinned.load.52.26 = load double, ptr %address.51.217, align 8
  store double %pinned.load.52.26, ptr %value.26, align 8
  %load.53.27.0 = load double, ptr %out.1, align 8
  %load.53.27.1 = load double, ptr %out.2, align 8
  %scalar.53.27 = fsub double %load.53.27.0, %load.53.27.1
  store double %scalar.53.27, ptr %value.27, align 8
  %load.54.29.1 = load double, ptr %out.3, align 8
  ...
  %load.72.49.0 = load double, ptr %out.4, align 8
  ...
  %load.73.51.0 = load double, ptr %out.5, align 8
  ...
  %load.90.85.0 = load double, ptr %out.6, align 8
...
ew.done.91.90:
  ...
  %scalar.101.105 = mul i32 %load.31.207.0, %convert.101.105.1
  ...
  %scalar.103.109 = mul i32 %load.31.207.0, %convert.103.109.1
  ...
  %scalar.105.113 = mul i32 %load.31.207.0, %convert.105.113.1
...
ew.body.124.136:
  ...
  %ew.op.124.136.1 = load double, ptr %out.8, align 8
...
ew.done.129.141:
  ...
  %address.145.218 = getelementptr double, ptr %arg.10, i32 %load.31.207.0
  store double %scalar.134.146, ptr %address.145.218, align 8
  %load.147.219.0 = load i32, ptr %arg.1, align 4
  %address.147.219 = getelementptr double, ptr %arg.11, i32 %load.147.219.0
  %load.store.148.v = load double, ptr %value.147, align 8
  store double %load.store.148.v, ptr %address.147.219, align 8
  %load.149.220.0 = load i64, ptr %value.107, align 8
  %convert.149.220.0 = trunc i64 %load.149.220.0 to i32
  %address.149.220 = getelementptr double, ptr %arg.13, i32 %convert.149.220.0
  %load.store.150.v = load double, ptr %value.146, align 8
  store double %load.store.150.v, ptr %address.149.220, align 8
  %load.151.221.0 = load i64, ptr %value.111, align 8
  %convert.151.221.0 = trunc i64 %load.151.221.0 to i32
  %address.151.221 = getelementptr double, ptr %arg.13, i32 %convert.151.221.0
  %load.store.152.v = load double, ptr %value.149, align 8
  store double %load.store.152.v, ptr %address.151.221, align 8
  %load.153.222.0 = load i64, ptr %value.115, align 8
  %convert.153.222.0 = trunc i64 %load.153.222.0 to i32
  %address.153.222 = getelementptr double, ptr %arg.13, i32 %convert.153.222.0
  %load.store.154.v = load double, ptr %value.156, align 8
  store double %load.store.154.v, ptr %address.153.222, align 8
  ret void
}
...
entry:
  %value.174 = alloca i64, i64 1, align 8
  ...
  %value.187 = alloca i1, i64 1, align 8
  store i64 0, ptr %value.174, align 8
  store i64 1, ptr %value.175, align 8
  store i64 0, ptr %value.189, align 8
  store i64 1, ptr %value.191, align 8
  store i64 2, ptr %value.193, align 8
  store i64 3, ptr %value.195, align 8
  store i64 4, ptr %value.197, align 8
  store i64 5, ptr %value.199, align 8
  store i64 6, ptr %value.201, align 8
  store i64 7, ptr %value.203, align 8
  store i64 8, ptr %value.205, align 8
  %load.cast.11.23 = load double, ptr %arg.9, align 8
  store double %load.cast.11.23, ptr %value.23, align 8
  %load.cast.12.22 = load double, ptr %arg.8, align 8
  store double %load.cast.12.22, ptr %value.22, align 8
  %load.cast.13.19 = load double, ptr %arg.5, align 8
  store double %load.cast.13.19, ptr %value.19, align 8
  %load.cast.14.24 = load double, ptr %arg.10, align 8
  store double %load.cast.14.24, ptr %value.24, align 8
  %load.cast.15.16 = load double, ptr %arg.2, align 8
  store double %load.cast.15.16, ptr %value.16, align 8
  %load.cast.16.17 = load double, ptr %arg.3, align 8
  store double %load.cast.16.17, ptr %value.17, align 8
  %load.cast.17.21 = load double, ptr %arg.7, align 8
  store double %load.cast.17.21, ptr %value.21, align 8
  %load.cast.18.18 = load double, ptr %arg.4, align 8
  store double %load.cast.18.18, ptr %value.18, align 8
  %load.cast.19.20 = load double, ptr %arg.6, align 8
  store double %load.cast.19.20, ptr %value.20, align 8
  br label %loop_header
loop_header:
  %phi.185 = phi ptr [ %value.174, %entry ], [ %value.186, %loop_latch ]
  %phi.176 = phi ptr [ %arg.9, %entry ], [ %value.230, %loop_latch ]
  %phi.177 = phi ptr [ %arg.8, %entry ], [ %value.229, %loop_latch ]
  %phi.178 = phi ptr [ %arg.5, %entry ], [ %value.226, %loop_latch ]
  %phi.179 = phi ptr [ %arg.10, %entry ], [ %value.231, %loop_latch ]
  %phi.180 = phi ptr [ %arg.2, %entry ], [ %value.223, %loop_latch ]
  %phi.181 = phi ptr [ %arg.3, %entry ], [ %value.224, %loop_latch ]
  %phi.182 = phi ptr [ %arg.7, %entry ], [ %value.228, %loop_latch ]
  %phi.183 = phi ptr [ %arg.4, %entry ], [ %value.225, %loop_latch ]
  %phi.184 = phi ptr [ %arg.6, %entry ], [ %value.227, %loop_latch ]
  %load.31.187.0 = load i32, ptr %phi.185, align 4
  %load.31.187.1 = load i32, ptr %arg.0, align 4
  %scalar.31.187 = icmp slt i32 %load.31.187.0, %load.31.187.1
  store i1 %scalar.31.187, ptr %value.187, align 1
  br i1 %scalar.31.187, label %loop_body, label %loop_exit
loop_body:
  call void @__ssa_engine_toy_structure__beam_bank_run__planned_region_0(ptr %phi.180, ptr %phi.185, ptr %phi.181, ptr %phi.183, ptr %phi.178, ptr %phi.184, ptr %phi.182, ptr %phi.177, ptr %phi.176, ptr %phi.179, ptr %arg.11, ptr %arg.12, ptr %arg.1, ptr %arg.13, ptr %value.223, ptr %value.224, ptr %value.225, ptr %value.226, ptr %value.227, ptr %value.228, ptr %value.229, ptr %value.230, ptr %value.231, ptr %extents)
  br label %loop_latch
loop_latch:
  %load.53.186.0 = load i32, ptr %phi.185, align 4
  %load.53.186.1 = load i64, ptr %value.175, align 8
  %convert.53.186.1 = trunc i64 %load.53.186.1 to i32
  %scalar.53.186 = add i32 %load.53.186.0, %convert.53.186.1
  %declared.53.186 = sext i32 %scalar.53.186 to i64
  store i64 %declared.53.186, ptr %value.186, align 8
  br label %loop_header
loop_exit:
  %phi.162 = phi ptr [ %phi.176, %loop_header ]
  %phi.163 = phi ptr [ %phi.177, %loop_header ]
  %phi.164 = phi ptr [ %phi.178, %loop_header ]
  %phi.165 = phi ptr [ %phi.179, %loop_header ]
  %phi.166 = phi ptr [ %phi.180, %loop_header ]
  %phi.168 = phi ptr [ %phi.181, %loop_header ]
  %phi.171 = phi ptr [ %phi.182, %loop_header ]
  %phi.172 = phi ptr [ %phi.183, %loop_header ]
  %phi.173 = phi ptr [ %phi.184, %loop_header ]
  %return.load.0.68 = load double, ptr %arg.13, align 8
